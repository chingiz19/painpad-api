...
async function search(parent, { text }, { req }) {
    ...
    let result_TopicPosts = await Search.searchPosts(userId, text, null, (7 + 5) - totCount);
    ...
    let result_locationPosts = await Search.searchPosts(userId, null, text, 15 - totCount);
